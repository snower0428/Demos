 ...
 */
@protocol VPGPUImageMovieDelegate <NSObject>
 ...
 */
@interface VPGPUImageMovie : GPUImageOutput
 ...
 */
@property (readwrite, nonatomic, assign) id <VPGPUImageMovieDelegate>delegate;
