...
@interface VPGPUImageMovie () <AVPlayerItemOutputPullDelegate>
{
...
@implementation VPGPUImageMovie
...
- (void)startProcessing
{
    ...
    VPGPUImageMovie __block *blockSelf = self;
...
- (void)processAsset
{
    ...
    __unsafe_unretained VPGPUImageMovie *weakSelf = self;
