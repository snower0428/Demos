...
@implementation GPUCustomFilter
...
- (instancetype)init {
    ...
    self.cannyEdgeDetectionFilter = [[GPUImageCannyEdgeDetectionFilter alloc] init];
    [self addFilter:self.cannyEdgeDetectionFilter];
    ...
    [self.cannyEdgeDetectionFilter addTarget:self.combinationFilter];
    
    [self.combinationFilter addTarget:self.hsbFilter];
    
    self.initialFilters = [NSArray arrayWithObjects:self.bilateralFilter, self.cannyEdgeDetectionFilter, self.combinationFilter,nil];
