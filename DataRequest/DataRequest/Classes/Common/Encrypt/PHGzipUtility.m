...
#pragma clang diagnostic pop
    ...
    NSUInteger length = [pUncompressedData length] * 1.1 + 12;
    if (length < 512) {
        length = 512;
    }
    NSMutableData *compressedData = [NSMutableData dataWithLength:length];
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wunused-value"
    NSLog(@"%s: Compressed file from %zd KB to %zd KB", __func__, [pUncompressedData length]/1024, [compressedData length]/1024);
#pragma clang diagnostic pop
