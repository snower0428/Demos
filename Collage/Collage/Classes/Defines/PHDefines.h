...
#define iPhone6OrPlus (([GBDeviceInfo deviceInfo].model == GBDeviceModeliPhone6)||([GBDeviceInfo deviceInfo].model == GBDeviceModeliPhone6Plus) || ([GBDeviceInfo deviceInfo].model == GBDeviceModeliPhone6s) || ([GBDeviceInfo deviceInfo].model == GBDeviceModeliPhone6sPlus))
#define iPhone7OrPlus	(([GBDeviceInfo deviceInfo].model == GBDeviceModeliPhone7)||([GBDeviceInfo deviceInfo].model == GBDeviceModeliPhone7Plus))
...
#define DOWNLOAD_PATH       [DOCUMENTS_DIRECTORY stringByAppendingPathComponent:@"Download"]

//拼图
#define kDirectoryForImageCombine   [DOWNLOAD_PATH stringByAppendingPathComponent:@"ImageCombine"]
#define kPathForImageCombineResourceBundle   [kDirectoryForImageCombine stringByAppendingPathComponent:@"ImageCombineResource.bundle"]
#define kPathForImageCombineResourceBundleInfo      [kDirectoryForImageCombine stringByAppendingPathComponent:@"ImageCombineResourceInfo.plist"]
