...
@interface PHImagePickerAssetView ()

@property (nonatomic, retain) UIImageView *imageView;
@property (nonatomic, retain) PHImagePickerVideoInfoView *videoInfoView;
...
@implementation PHImagePickerAssetView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if(self) {
        ...
        // Video Info View
        PHImagePickerVideoInfoView *videoInfoView = [[PHImagePickerVideoInfoView alloc] initWithFrame:CGRectMake(0, self.bounds.size.height - 17, self.bounds.size.width, 17)];
        ...
        overlayImageView.image = [UIImage imageNamed:@"Resource/Image/ImageCombine/overlay.png"];
